...
namespace Game.Utils {
    public static class PlanetFactory {
        ...
        private static readonly Dictionary<PlanetTexture, string> PLANET_TEXTURES =
            new Dictionary<PlanetTexture, string> {
        ...
        public static Planet GeneratePlanetWithAsteroidBeld(PlanetTexture planetTexture,
            ...
            var randomEuler = new Vector3d(0,0,1.5708);
            
            planet.TransformComponent.Orientation = Quaterniond.FromEulerAngles(randomEuler);
            
            //planet.MoveComponent.AngularVelocity = new Vector3d(1,1,0);
            ...
            for (var i = 0; i < numberAsteroids; i++) {
                ...
                component.currentAngle = i * 1.0 / 4.75;
