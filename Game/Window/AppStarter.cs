...
namespace Game.Window
{
    internal class AppStarter : GameWindow
    {
        ...
        private AppStarter()
            : base(1280, 720, new GraphicsMode(32, 24, 8, 2), "CGI-MIN Example", GameWindowFlags.Default,
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            _asteroid = new Asteroid(asteroid0Model, new Vector3(1.0f, 0.5f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f),
                new Vector3(1.0f));
